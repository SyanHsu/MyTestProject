    ...
    public class Benchmark01_UGUI : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            if (BenchmarkType == 0) // TextMesh Pro Component
            {
                ...
                m_material02 = Resources.Load<Material>("Fonts & Materials/LiberationSans SDF - Metalic Green"); // Make sure the LiberationSans SDF exists before calling this...  
                Debug.Log(m_material02 == null);
