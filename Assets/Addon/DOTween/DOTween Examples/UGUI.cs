...
public class UGUI : MonoBehaviour
{
	...
	void Start()
	{
		...
		text.DOText("This text will <b><size=18>replace</size></b> the existing one", 2).SetEase(Ease.Linear).SetAutoKill(false).Pause();
		...
		scrambledText.DOText("This text will appear from scrambled chars", 2, true, ScrambleMode.Custom, "ABCDEFGHIK").SetEase(Ease.Linear).SetAutoKill(false).Pause();
